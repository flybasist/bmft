...
Модульный бот для модерации и автоматизации Telegram-чатов: лимиты, статистика, реакции, фильтр мата, задачи по расписанию. Поддерживает Telegram Forums (топики).
