...
func (m *ReactionsModule) RegisterCommands(bot *telebot.Bot) {
	...
	bot.Handle("/reactions", func(c telebot.Context) error {
		...
		msg += "   📌 Пример: <code>/addreaction привет Привет!</code>\n\n"
		...
		msg += "• Команда в <b>топике</b> настраивает реакции только для этого топика\n"
		msg += "• Команда в <b>основном чате</b> настраивает реакции для всего чата\n\n"

		msg += "💡 <i>Подсказка:</i> VIP-пользователи могут триггерить реакции без ограничений."
