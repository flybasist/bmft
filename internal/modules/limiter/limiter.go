...
func (m *LimiterModule) RegisterCommands(bot *tele.Bot) {
	...
	bot.Handle("/limiter", func(c tele.Context) error {
		...
		msg += "   📌 Примеры:\n"
		msg += "   • <code>/setlimit photo 10</code> — максимум 10 фото в день\n"
		msg += "   • <code>/setlimit sticker 20</code> — максимум 20 стикеров в день\n"
		msg += "   • <code>/setlimit text 0</code> — отключить лимит на текст\n\n"
