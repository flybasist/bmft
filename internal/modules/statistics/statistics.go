...
// Русский комментарий: Собирает статистику по сообщениям в чатах.
// При каждом сообщении инкрементирует счётчики в statistics_daily.
// Предоставляет команды для просмотра статистики: /mystats, /chatstats, /topchat.
