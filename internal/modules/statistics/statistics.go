...
func (m *StatisticsModule) RegisterCommands(bot *tele.Bot) {
	...
	bot.Handle("/statistics", func(c tele.Context) error {
		msg := "📊 **Модуль Statistics** — Статистика активности\n\n"
		msg += "Собирает и анализирует данные об активности пользователей в чате.\n\n"
		msg += "**Доступные команды:**\n\n"

		msg += "🔹 `/myweek` — Ваша статистика за неделю\n"
		msg += "   Подробная аналитика активности за последние 7 дней\n"
		msg += "   📌 Пример: `/myweek`\n\n"

		msg += "🔹 `/chatstats` — Статистика чата (только админы)\n"
		msg += "   Общая статистика активности всего чата\n"
		msg += "   📌 Пример: `/chatstats`\n\n"

		msg += "🔹 `/topchat` — Топ активных пользователей (только админы)\n"
		msg += "   Рейтинг самых активных участников чата\n"
		msg += "   📌 Пример: `/topchat`\n\n"

		msg += "⚙️ **Работа с топиками:**\n"
		msg += "• Команда в **топике** показывает статистику только для этого топика\n"
		msg += "• Команда в **основном чате** показывает статистику для всего чата\n\n"

		msg += "💡 *Подсказка:* Статистика собирается автоматически для всех сообщений в чате."
