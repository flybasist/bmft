...
func (m *TextFilterModule) RegisterCommands(bot *telebot.Bot) {
	...
	bot.Handle("/textfilter", func(c telebot.Context) error {
		...
		msg += "  → Удалит любое из этих слов\n\n"

		msg += "<b>🔗 ЗАБАНИТЬ ВСЕ ССЫЛКИ:</b>\n"
		msg += "• <code>/addban http delete</code> - любые ссылки\n"
		msg += "• <code>/addban t.me delete</code> - только Telegram ссылки\n\n"
		...
		msg += "• Команда в основном чате — фильтры для всего чата\n\n"
