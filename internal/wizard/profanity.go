...
func (w *profanityWizard) renderStep(state *State) (string, *tele.ReplyMarkup) {
	...
	text := fmt.Sprintf(
		"<b>🚫 Фильтр ненормативной лексики</b>\n\n"+
			"Область: %s\n%s\n\n"+
			"Выберите действие фильтра:\n"+
			"• <b>delete</b> — удалить сообщение молча\n"+
			"• <b>warn</b> — предупредить (сообщение остаётся)\n"+
			"• <b>delete_warn</b> — удалить и предупредить\n\n"+
			"VIP-пользователи фильтр игнорируют.",
		scope, statusLine,
	)
